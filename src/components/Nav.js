...
const Nav = () => {
    return (
        ...
        <img src="./images/logo1.png" alt="" className="img-fluid" style={{width:"100px"}}/>
          </Link>
        <div className="d-flex align-items-center">
          <div><i className='bx bxs-location-plus text-white custom-link'></i></div>
          <div><p style={{color:'#CCCCCC',fontSize:'12px'}}>Deliver to</p>
  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <Link className="nav-link text-black" to="#">Link</Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link text-black" to="#">Disabled</Link>
        </li>
      </ul>
